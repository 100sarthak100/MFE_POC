                ...
                <div style={{ flex: "3 1 30rem" }}>
                    <ul style={{ paddingLeft: "0", listStyleType: "none", padding: "1rem" }}>
                        ...
                        <li style={{ marginBottom: "1rem" }}>
                            {
                                !c.length ? (
                                    <div style={{ borderBottom: "0.1rem #808080 solid", marginBottom: "40%" }}>
                                        <h2>Cart is empty</h2>
                                    </div>
                                ) : (
                                        c.map((object, index) =>
                                            <div key={object.productId} style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "1rem", borderBottom: "0.1rem #808080 solid" }}>
                                                <div style={{ flex: "1 1" }}>
                                                    <img src={object.productImgFile} alt="product" style={{ width: "15rem", height: "10rem", margin: "1em" }} />
                                                </div>
                                                <div style={{ flex: "8 1", margin: "1em" }}>
                                                    <div style={{ marginBottom: "0.5em" }}>
                                                        <Link to={"/Nav1/products/" + object.productId}>{object.productName}</Link>
                                                    </div>
